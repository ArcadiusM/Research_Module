...
\subsection{Application of random forest}
...
\begin{figure}[H]
    \captionsetup{format=plain}
    \makebox[\textwidth]{\includegraphics[width=120mm]{confusion_matrix_gradient_boosting.png}}
...
%     \captionsetup{format=plain}
%     \makebox[\textwidth]{\includegraphics[width=120mm]{confusion_matrix_gradient_boosting.png}}
%     \caption{This plot illustrates the accuracy of the Gradient Boosting Classifier's prediction on the Titanic data set.}
%     \label{fig:confusion_matrix_gradient_boosting}
% \end{figure}
