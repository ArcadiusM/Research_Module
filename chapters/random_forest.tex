...
After training Random Forest model, we use OOB sample used as validation set. 
Every Decision Tree in Random Forest is validated with corresponding leftover sample and averaged to calculate Out of Bag estimate \cite{friedman2001elements}. Out of Bag sample is commonly used to monitor error of predictions. 
